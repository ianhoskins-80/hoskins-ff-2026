...
- Each league's banner shows that league's combined total projected points for the week, a running combined total-so-far once any game in that league has started, and that league's combined season-to-date points (sum of every team's `pointsFor`)
